...
<style>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="admlisteloca.php" method="GET">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="admloca.php" class="btn btn-dark">Ajouter une location</a>
            </div>
            <div class="col-md-4"></div>
        </div>
    </form>
    <?php
        ...
        while ($donnee = mysqli_fetch_array($result)){
            echo "<tr>";
            echo "<td>";
                echo "<a href = 'admsupploca.php?idloca=".$donnee['idloca']."' class=' btn btn-dark '>Supprimer</a>";
            echo "</td>";
            echo "<td>";
                echo "<a href = 'admmodifloca.php?idloca=".$donnee['idloca']."&nomloca=".$donnee['nomloca']."&prenomloca=".$donnee['prenomloca']."&emailloca=".$donnee['emailloca']."&telephoneloca=".$donnee['telephoneloca']."&typereseloca=".$donnee['typereseloca']."&nombrepersonneloca=".$donnee['nombrepersonneloca']."&nombrejourloca=".$donnee['nombrejourloca']."&arriveloca=".$donnee['arriveloca']."&departloca=".$donnee['departloca']."&infoloca=".$donnee['infoloca'].""."' class=' btn btn-dark '>Modifier</a>";
            echo "</td>";
            echo "<td>";
                echo $donnee ["idloca"];
            echo "</td>";
