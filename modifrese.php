...
<html lang="fr">
<head>
    <link rel="stylesheet" href="CSS/modifrese.css">
...
<body class="fg">
<form action="modifrese.php" method="GET">
   ...
   <?php
      ...
      ?>
   <button type="reset" class="btn btn-dark"><a href="listerese.php">Annuler</a></button>
</form>
</body>
</html>