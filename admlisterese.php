...
<html lang="en">
<head>
    <link rel="stylesheet" href="CSS/admlisterese.css">
...
<style>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="admlisterese.php" method="GET">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="admrese.php" class="btn btn-dark">Ajouter une reservation</a>
            </div>
            <div class="col-md-4"></div>
        </div>
    </form>
